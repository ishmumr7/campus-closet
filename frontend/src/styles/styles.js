const styles = {
  ...
  button: 'w-[150px] bg-[#8C1C13] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer hover:brightness-75 transition duration-300 ',
  hover_effect: 'hover:scale-105 transition-transform duration-300 ease-in-out',
